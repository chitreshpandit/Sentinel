...
$restMethodParams = @{
    Path    = "/subscriptions/6874b9d3-0bbe-43fd-9182-ec44214b1b4d/resourcegroups/chitpa-sentinel-rg-01/providers/microsoft.operationalinsights/workspaces/sentinel-ws-sea-01/tables/AWSWAFEvents_CL?api-version=2025-07-01"
    Method  = "PUT"
    Payload = $tableParams}
